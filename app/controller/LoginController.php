...
class loginController extends Controller
{
    ...
    public function negado()
    {
        $this->view('externa/message',[
            'message' => 'Você precisa fazer o login para acessar o banco.'
        ]);
    }
    ...
    public function register()
    {
        ...
        if (!$this->validate($formData)) {
            $this->view('externa/message',[
                'message' => 'Pra cair aqui você tá tentando aprontar...'
            ] );
            return;
        }
        ...
        if(is_dir($dirPath)){
            $this->view('externa/message',[
                'message' => 'CPF já cadsatrdo, tente novamente.'
            ] );
            return;
        }
